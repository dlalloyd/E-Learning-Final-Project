...
\begin{itemize}[leftmargin=2em]
  ...
  \item The 13-KC curriculum ontology and prerequisite graph, covering UK
    physical geography and climate (spatial recall, climate processes, and
    integrative application), and its 12-edge DAG encoding causal
    prerequisites between knowledge components.
